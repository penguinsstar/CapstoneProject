 ...
 *
 * Calculate_DBP_data.c
 *
 * Code generation for function 'Calculate_DBP_data'
 *
 */
...
boolean_T isInitialized_Calculate_DBP = false;

/* End of code generation (Calculate_DBP_data.c) */
